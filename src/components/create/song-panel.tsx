...
export function SongPanel(){
    ...
    return <div className="bg-muted/30 flex w-full flex-col boreder-r lg:w-80">
        <div className="flex-1 overflow-y-auto p-4">
            <Tabs value={mode} onValueChange={(value) => setMode(value as "simple" | "custom")}>
                ...
                <TabsContent value="simple" className="mt-6 space-y-6">
                    ...
                    placeholder="A dreamy lofi hip-hop song perfect for studying" 
                    ...
                    <div className="flex items-center justify-between">
                        <Button variant="outline" size="sm" onClick={()=> setMode("custom")}>
                            <Plus className="mr-2"/>
                            Lyrics
                        </Button>
                    ...
                    <div className="flex flex-col gap-3">
                       <div className=" flex items-center justify-between">                        
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            className="h-7 text-xs">Auto</Button>
                            ...
                            className="h-7 text-xs">Write</Button>  

                         
                        </div>
                      </div>
                                                  <Textarea 
                            placeholder={lyricsMode === "write" ? "Add your own lyrics here" : "Describe your desired lyrics, e.g., Sad love song"}
        ...
        <div className="border-t p-4">
            ...
            disabled={loading} className="w-full cursor-pointer bg-gradient-to-r from-orange-500 to-pink-500 font-medium text-white hover:from-orange-600 hover:to-pink-600">
                
                {loading ? <Loader className="animate-spin"/> : <Music/> }
