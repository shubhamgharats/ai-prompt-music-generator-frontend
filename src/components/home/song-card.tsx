"use client"
import type { Category, Song, Like } from "generated/prisma"
...
{song.thumbnailUrl ? (
  ...
  <div className="bg-muted flex h-full w-full items-center justify-center">
    <Music className="text-muted-foreground h-12 w-12" />
            ...
            <h3 className="mt-2 turncate text-sm font-medium text-gray-900">{song.title}</h3>
            ...
            <div className="mt-1 flex items-center justify-between text-xs text-gray-900 ">
                ...
                <button onClick={handleLike} className="flex cursor-pointer items-center gap-1"><Heart className={`h-4 w-4 ${isLiked? "fill-red-500 text-red-500 ":""}`}/>
